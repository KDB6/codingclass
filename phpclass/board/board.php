...
<?php
    // 두개의 테이블 join
    $sql = "SELECT b.boardID, b.boardTitle, m.youName, b.regTime, b.boardView FROM myStudyBoard b JOIN myStudyMember m ON (b.memberID = m.memberID) ORDER BY boardID DESC LIMIT {$viewLimit}, {$viewNum}";
...
?>
                ...
                <div class="board__pages">
                    <ul>
<?php
    $sql = "SELECT count(boardID) FROM myStudyBoard";
    $result = $connect -> query($sql);
