<?php
    ...
    $sql .=     "shopItemLink01 varchar(500) DEFAULT NULL,";
    $sql .=     "shopItemLink02 varchar(500) DEFAULT NULL,";
    $sql .=     "shopItemLink03 varchar(500) DEFAULT NULL,";
    $sql .=     "shopItemLink04 varchar(500) DEFAULT NULL,";
