...
<?php
    ...
    // echo $boardID;
    // 보드뷰 + 1(UPDATE)
    $sql = "UPDATE myStudyBoard SET boardView = boardView + 1 WHERE boardID = {$boardID}";
    $connect -> query($sql);
    $sql = "SELECT b.boardTitle, m.youName, b.regTime, b.boardView, b.boardContents FROM myStudyBoard b JOIN myStudyMember m ON(m.memberID = b.memberID) WHERE b.boardID = {$boardID}";
