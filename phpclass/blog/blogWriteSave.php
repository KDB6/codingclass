    ...
    if($blogImgType){
        ...
        if($fileType == "image"){
            ...
            if($fileExtension == "jpg" || $fileExtension == "jpeg" || $fileExtension == "gif" || $fileExtension == "png"){
                ...
                $sql = "INSERT INTO myStudyBlog(memberID, blogTitle, blogContents, blogCategory, blogAuthor, blogView, blogLike, blogImgFile, blogImgSize, blogDelete, blogRegTime) VALUES('$memberID', '$blogTitle', '$blogContents', '$blogCategory', '$blogAuthor', '$blogView', '$blogLike', '$blogImgName', '$blogImgSize', '0', '$regTime')";
            } else {
        ...
        //echo "이미지 파일이 아닙니다.";
        $sql = "INSERT INTO myStudyBlog(memberID, blogTitle, blogContents, blogCategory, blogAuthor, blogView, blogLike, blogImgFile, blogDelete, blogRegTime) VALUES('$memberID', '$blogTitle', '$blogContents', '$blogCategory', '$blogAuthor', '$blogView', '$blogLike', 'Img_default.jpg', '0', '$regTime')";
    }
    //이미지 사이즈 확인
