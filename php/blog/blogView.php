    ...
    foreach($commentResult as $comment) { ?>
        ...
        <div class="comment__view">
            <div class="comment__view__img">
                <img src="../assets/img/blog/apple01.jpg" alt="">
            </div>
            <div class="comment__view__data">
                <span class="name">KDB</span>
...
<?php } ?>
                        ...
                        <div class="comment__modify" style="display: none">
                            ...
                            <label for="commentModifyMsg">비밀번호</label>
                        ...
                        <div class="comment__write">
                            <div class="comment__write__info">
                                ...
                                <input type="text" id="commentPass" id="commentPass" placeholder="비밀번호">
